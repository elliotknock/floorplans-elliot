...
export function initScaleBackground(fabricCanvas, getCroppedCanvas, updateStepIndicators, closeAllPopups) {
  ...
  let scaleStartPoint = null, scaleEndPoint = null, isDragging = false, hasMoved = false;
  let backgroundImage, croppedCanvasData = null;
  ...
  const initScaleCanvas = (croppedCanvas) => {
    ...
    fabric.Image.fromURL(
      ...
      (img) => {
        ...
        const btnWidth = 110, btnHeight = 26, btnMargin = 10;
        const btnLeft = canvasWidth - btnMargin - btnWidth, btnTop = 16;
