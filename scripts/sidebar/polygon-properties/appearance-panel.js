...
export function initAppearancePanel(detailsPanelInstance) {
  ...
  function updateZoneText() {
    ...
    updatePolygonText(currentPolygon, currentTextObject, canvas, 
      { name: zoneNameToggle, area: zoneAreaToggle, volume: zoneVolumeToggle, notes: zoneNotesToggle }, 
      name, notes, height, true
    );
  }
  ...
  function updateRoomText() {
    ...
    const volume = area * height;
    updatePolygonText(currentRoomPolygon, currentRoomText, canvas, 
      { name: roomNameToggle, area: roomAreaToggle, volume: roomVolumeToggle, notes: roomNotesToggle }, 
      name, notes, height, false
    );
