...
window.onload = function () {
  ...
  if (typeof window.ProjectManager !== "undefined") {
    const projectManager = new window.ProjectManager(fabricCanvas, enhancedSaveSystem);
    window.projectManager = projectManager;
  } else {
    // Import and initialize project manager
    import("../save/project-manager.js").then((module) => {
