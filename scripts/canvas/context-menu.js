...
export function initContextMenu(fabricCanvas) {
  ...
  Object.assign(menu.style, {
    position: "fixed", background: "#e0e0e0", color: "#000",
    border: "1px solid rgba(0,0,0,0.2)", borderRadius: "6px", padding: "6px",
    display: "none", zIndex: 3000, boxShadow: "0 6px 18px rgba(0,0,0,0.4)",
  });
        ...
        if (target.textObject) {
          ...
          try {
            ...
            textClone = new fabric.Text(label, {
              left: cloned.left + 20, top: cloned.top + 40,
              fontFamily: orig.fontFamily || "Poppins, sans-serif",
              fontSize: orig.fontSize || 12, fill: orig.fill || "#FFFFFF",
